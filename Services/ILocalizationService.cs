    ...
    public LocalizationService()
    {
        ...
        _translations = new Dictionary<string, Dictionary<string, string>>
        {
            ["es"] = new Dictionary<string, string>
            {
                ...
                ["warranty_title"] = "Exención de responsabilidad",
                ["warranty_text"] = "El software se entrega \"tal como está\", sin garantías de ningún tipo, expresas o implícitas. En ningún caso los autores serán responsables de reclamaciones, daños u otras responsabilidades derivadas del uso del software. El uso es bajo tu propio riesgo; al usar la aplicación, eximes al desarrollador de toda responsabilidad.",
            ...
            ["en"] = new Dictionary<string, string>
            {
                ...
                ["warranty_title"] = "Disclaimer of Liability",
                ["warranty_text"] = "The software is provided \"as is\", without warranty of any kind, express or implied. In no event shall the authors be liable for any claim, damages or other liability arising from the use of the software. Use is at your own risk; by using the app, you release the developer from all liability.",
